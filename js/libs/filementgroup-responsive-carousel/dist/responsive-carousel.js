	...
	var pluginName = "carousel",
		...
		methods = {
			...
			_addNextPrev: function(){
				return $( this )
					.append( "<nav class='"+ navClass +"'><a href='#prev' class='nav-item previous' aria-hidden='true' title='Previous'>&larr;</a><a href='#next' class='nav-item next' aria-hidden='true' title='Next'>&rarr;</a></nav>" )
...
(function($) {
	...
	// DOM-ready auto-init
	$( initSelector ).bind( "create." + pluginName, function(){
